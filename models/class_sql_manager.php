...
//CLASS SQL MANAGER
	...
	//CONSULTAS 
		...
		// SELECT 
		public function select_from($table,$where = "")
		{
			...
			if($this->result)
				...
				$this->registros = $this->result->fetch_array(MYSQLI_ASSOC);
		}
		// UPDATE 
		...
		public function ejecutar(){
			...
			//if($this->result)
				// Obtener campos : Array 
				//$this->registros = $this->result->fetch_row();
